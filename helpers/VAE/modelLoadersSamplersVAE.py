...
def load_variational_mgt_model(model_path, params_dict=None, eval=True, device=None):
...
def predict_using_mgt(trained_model, input_tensor, voice_thresholds, voice_max_count_allowed,
    ...
    with torch.no_grad():
        ...
        if isinstance(trained_model, GrooveTransformerEncoderVAE):
            # Nx32xembedding_size_src/3,Nx32xembedding_size_src/3,Nx32xembedding_size_src/3
            _h_logits, v, o = trained_model.forward(input_tensor)
