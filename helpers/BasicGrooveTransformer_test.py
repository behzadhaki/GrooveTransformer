...
if __name__ == '__main__':
    ...
    # test input layer
    from src.BasicGrooveTransformer import InputLayer
    ...
    # test output layer
    from src.BasicGrooveTransformer import OutputLayer
    ...
    # test transformer
    from src.BasicGrooveTransformer import GrooveTransformer
    ...
    print("TEM")
    from src.BasicGrooveTransformer import GrooveTransformerEncoder
