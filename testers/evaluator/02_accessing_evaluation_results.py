if __name__ == "__main__":
    ...
    save_wav_file(os.path.join("testers/evaluator/misc/rendered_audio", fname), data, 44100)

    # 2.5 - Exporting gt and predictions to midi files
    evaluator_test_set.export_to_midi(need_gt=True, need_pred=True, directory="testers/evaluator/misc")
    ...
    evaluator_test_set.get_global_features_plot(only_combined_data_needed=False,
                                                save_path="testers/evaluator/misc/global_features_all.html", plot_width=1200, plot_height=800,
                                                kernel_bandwidth=0.05)
    evaluator_test_set.get_global_features_plot(only_combined_data_needed=True,
                                                save_path="testers/evaluator/misc/global_features_combinedOnly.html", plot_width=1200, plot_height=800,
                                                kernel_bandwidth=0.05)
    ...
    rhythmic_distances_plot = evaluator_test_set.get_rhythmic_distances_of_pred_to_gt_plot(
        save_path="testers/evaluator/misc/rhythmic_distances_plots.html", plot_width=1200, plot_height=800, kernel_bandwidth=0.05)
    ...
    statistics_of_hit_scores = evaluator_test_set.get_statistics_of_pos_neg_hit_scores(hit_weight=1,
                                                                                       trim_decimals=1,
                                                                                       csv_file="testers/evaluator/misc/hit_scores.csv")
    pos_neg_hit_plots = evaluator_test_set.get_pos_neg_hit_plots(save_path="testers/evaluator/misc/pos_neg_hit_plots",
    ...
    velocity_plots = evaluator_test_set.get_velocity_distribution_plots(
        save_path="testers/evaluator/misc/velocity_plots.html", plot_width=1200, plot_height=800, kernel_bandwidth=0.05)
    ...
    offset_plots = evaluator_test_set.get_velocity_distribution_plots(
        save_path="testers/evaluator/misc/offset_plots.html", plot_width=1200, plot_height=800, kernel_bandwidth=0.05)
