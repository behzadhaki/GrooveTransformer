...
if __name__ == '__main__':
    ...
    for set_labels in eval_labels:
        ...
        csv_path = f"post_training_evaluations/evaluators_monotonic_groove_transformer_v1/mgeval_results/" \
        ...
        fig_path = f"post_training_evaluations/evaluators_monotonic_groove_transformer_v1/mgeval_results/" \
