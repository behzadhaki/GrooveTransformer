...
if __name__ == '__main__':
    ...
    for run_name in run_names:
        test_set_evaluator = load_evaluator(f"eval/saved/monotonic_groove_transformer_v1/validation_set_evaluator_run_{run_name}.Eval")

        df_compiled = get_stats_from_evaluator(test_set_evaluator, csv_file="eval/post_training_evaluations/saved_results/test_data.csv").transpose()
        df_compiled.to_csv(f"eval/post_training_evaluations/saved_results/{run_name}.csv")