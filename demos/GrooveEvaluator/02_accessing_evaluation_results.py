if __name__ == "__main__":
    ...
    statistics_of_hit_scores = evaluator_test_set.get_statistics_of_pos_neg_hit_scores(hit_weight=1,
                                                                                       trim_decimals=1,
                                                                                       csv_file="demos/GrooveEvaluator/misc/GrooveEvaluator/hit_scores.csv")
    ...
    statistics_of_velocitiy_distributions = evaluator_test_set.get_statistics_of_velocity_distributions(
        trim_decimals=1, csv_file="demos/GrooveEvaluator/misc/GrooveEvaluator/vel_stats.csv")
    ...
    statistics_of_offsetocitiy_distributions = evaluator_test_set.get_statistics_of_offset_distributions(
        trim_decimals=1, csv_file="demos/GrooveEvaluator/misc/GrooveEvaluator/offset_stats.csv")
    ...
    rhythmic_distances_statistics_df = evaluator_test_set.get_statistics_of_rhythmic_distances_of_pred_to_gt(
        tag_by_identifier=False, csv_dir="demos/GrooveEvaluator/misc/GrooveEvaluator/distances", trim_decimals=3)
    ...
    get_statistics_of_global_features_df = evaluator_test_set.get_statistics_of_global_features(
        calc_gt=True, calc_pred=True, csv_file="demos/GrooveEvaluator/misc/GrooveEvaluator/global_features_statistics.csv", trim_decimals=3)
    ...
    pos_neg_hit_plots = evaluator_test_set.get_pos_neg_hit_plots(
        save_path="demos/GrooveEvaluator/misc/GrooveEvaluator/pos_neg_hit_plots.html", prepare_for_wandb=True,
        plot_width=1200, plot_height=800,
        kernel_bandwidth=0.05)

    # 3.B - Get Statistics of velocity distributions
    velocity_plots = evaluator_test_set.get_velocity_distribution_plots(
        save_path="demos/GrooveEvaluator/misc/GrooveEvaluator/velocity_plots.html", plot_width=1200, plot_height=800, prepare_for_wandb=True,
        kernel_bandwidth=0.05)

    # 3.C - Get Statistics of offset distributions
    offset_plots = evaluator_test_set.get_velocity_distribution_plots(
        save_path="demos/GrooveEvaluator/misc/GrooveEvaluator/offset_plots.html", plot_width=1200, plot_height=800, prepare_for_wandb=True,
        kernel_bandwidth=0.05)

    # 3.D - Get Rhythmic DIstances
    rhythmic_distances_plot = evaluator_test_set.get_rhythmic_distances_of_pred_to_gt_plot(
        save_path="demos/GrooveEvaluator/misc/GrooveEvaluator/rhythmic_distances_plots.html", plot_width=1200, plot_height=800, prepare_for_wandb=True,
        kernel_bandwidth=0.05)

    # 3.E - Get Global Features
    evaluator_test_set.get_global_features_plot(only_combined_data_needed=False, prepare_for_wandb=True,
                                                save_path="demos/GrooveEvaluator/misc/GrooveEvaluator/global_features_all.html",
                                                plot_width=1200, plot_height=800,
                                                kernel_bandwidth=0.05)
    evaluator_test_set.get_global_features_plot(only_combined_data_needed=True, prepare_for_wandb=True,
                                                save_path="demos/GrooveEvaluator/misc/GrooveEvaluator/global_features_combinedOnly.html",
                                                plot_width=1200, plot_height=800,
                                                kernel_bandwidth=0.05)
    ...
    evaluator_test_set.get_velocity_heatmaps(
        ...
        save_path="demos/GrooveEvaluator/misc/GrooveEvaluator/velocity_heatmaps.html")
