...
ROLAND_REDUCED_MAPPING = {
    "KICK": [36, 35, 96],
    "SNARE": [38, 37, 40, 75, 31, 39, 89, 76, 77, 30, 29, 91, 92, 93],
    "HH_CLOSED": [42, 22, 44, 69, 28, 54, 70, 73, 82, 32, 85, 25, 90],
    "HH_OPEN": [46, 26, 74],
    "TOM_3_LO": [43, 58, 41, 87, 86, 88] + [x for x in range(27)] + [x for x in range(94, 128)],
    "TOM_2_MID": [47, 45, 64, 61, 66, 68, 68],
    "TOM_1_HI": [50, 48, 63, 62, 60, 94, 95, 65, 71, 72, 67],
    "CRASH": [49, 52, 55, 57, 78, 79],
    "RIDE":  [51, 53, 59, 83, 81, 80, 34, 33, 56, 27, 84]
}
